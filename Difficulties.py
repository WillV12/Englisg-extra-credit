...
def easy():
    ...
    definitions = ["A metaphor developed at great length, occurring frequently in or throughout a "
                 ...
                 " or passage.",
                 "Writers using examples to prove a claim",
...
def medium():
    ...
    definitions = [" The use of slang or informalities in speech or writing.",
                 ...
                 "A type of sentence in which the main idea comes first, followed by dependent "
                 "grammatical units such as phrases and clauses.",
                 "If the writer uses the same or similar grammatical structure.",
